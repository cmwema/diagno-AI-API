...
def get_precautions(disease):
    return precautions[precautions['Disease'] == disease][['Precaution_1',
                                                           'Precaution_2',
                                                           'Precaution_3',
...
def helper(predicted_disease):
    ...
    workout = get_workout(predicted_disease)
...
symptoms_dict = {'itching': 0, 'skin_rash': 1, 'nodal_skin_eruptions': 2, 'continuous_sneezing': 3, 'shivering': 4,
                 ...
                 'red_spots_over_body': 99, 'belly_pain': 100,
...
diseases_list = {15: 'Fungal infection', 4: 'Allergy', 16: 'GERD', 9: 'Chronic cholestasis', 14: 'Drug Reaction',
                 ...
                 28: 'Jaundice',
                 29: 'Malaria', 8: 'Chicken pox', 11: 'Dengue', 37: 'Typhoid', 40: 'hepatitis A', 19: 'Hepatitis B',
                 20: 'Hepatitis C',
